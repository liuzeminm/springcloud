...
//    @Autowired
    ...
    @Value("${xxl.schedule.ssl.enabled:false}")
    private String sslEnabled;

    @Value("${xxl.schedule.ssl.pfxpath:UNKOWN}")
    private String pfxpath;

    @Value("${xxl.schedule.ssl.pfxpwd:UNKOWN}")
    private String pfxpwd;

    @Value("${xxl.comfig.api.client.maxTotal:200}")
    private int clientMaxTotal;

    @Value("${xxl.comfig.api.client.defaultMaxPerRoute:100}")
    private int clientDefaultMaxPerRoute;

    @Value("${xxl.config.api.client.clientRequestTimeout:2000}")
    private int clientConnectRequestTimeout;

    @Value("${xxl.config.api.client.clientRequestSocketTimeout:10000}")
    private int clientRequestSocketTimeout;

    @Value("${xxl.config.api.client.readTimeout:10000}")
    private int clientReadTimeout;

    @Value("${xxl.config.api.client.connectTimeout:5000}")
    private int clientConnectTimeout;

    @Value("${xxl.config.api.client.retryCount:2}")
