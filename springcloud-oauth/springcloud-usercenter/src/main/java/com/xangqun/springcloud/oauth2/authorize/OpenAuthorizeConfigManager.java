package com.xangqun.springcloud.oauth2.authorize;

import com.xangqun.springcloud.oauth2.authorize.provider.AuthAuthorizeConfigProvider;
...
public class OpenAuthorizeConfigManager implements AuthorizeConfigManager {
	...
	@Autowired
	private List<AuthAuthorizeConfigProvider> authorizeConfigProviders;
