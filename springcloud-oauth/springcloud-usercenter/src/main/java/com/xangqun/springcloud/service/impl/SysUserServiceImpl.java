...
import com.xangqun.springcloud.component.base.util.VerifyUtil;
import com.xangqun.springcloud.dto.PageResult;
import com.xangqun.springcloud.dto.Result;
import com.xangqun.springcloud.model.*;
import com.xangqun.springcloud.dao.SysUserDao;
import com.xangqun.springcloud.dao.SysUserRoleDao;
import com.xangqun.springcloud.oauth2.model.LoginAppUser;
import com.xangqun.springcloud.oauth2.model.SysRole;
import com.xangqun.springcloud.oauth2.model.SysUser;
import com.xangqun.springcloud.service.SysUserService;
import com.xangqun.springcloud.util.PageUtil;
import com.xangqun.springcloud.util.SysUserUtil;
...
public class SysUserServiceImpl implements SysUserService {
	...
	public void addSysUser(SysUser sysUser) {
		...
		if (VerifyUtil.isPhone(username)) {// 防止用手机号直接当用户名，手机号要发短信验证
